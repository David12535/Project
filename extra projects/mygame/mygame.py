...
money_image = pygame.image.load("chick.jpg").convert_alpha()
money_image = pygame.transform.scale(money_image, (100, 200))
jail_image = pygame.image.load("matrix_final.jpg").convert_alpha()
...
game_over_text = font.render(
    "The  Novatori got Dato, now it's time for Dato Berkacashvili to rise up and enslave people", True, red, black, )
...
score_text = font.render("Novatori caught in bed: " + str(score), True, white)
